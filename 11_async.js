const {sleep} = require("../es6/10_promise");
 ...
 */
const usingThen = (cb) => {
    sleep().then(() => cb()); // Attendre 2 secondes, puis exécuter le callback
}
...
//axios.get(url) : axios.get fait une requête HTTP GET à l'URL passée en paramètre.